    ...
    <main className="app-shell">
      ...
      <section className="mx-auto w-full max-w-5xl space-y-5 px-4 py-8 md:px-8">
        <header className="rounded-3xl border border-white/10 bg-white/5 p-6">
          <p className="text-xs uppercase tracking-[0.2em] text-cyan-200">บันทึกหลักฐาน</p>
          <h1 className="mt-2 text-3xl font-semibold text-white">/smv/log</h1>
          <p className="mt-2 text-sm text-slate-300">หน้านี้ใช้บันทึกหลักฐานเท่านั้น คะแนนหลักจะคำนวณใหม่อัตโนมัติ</p>

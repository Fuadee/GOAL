...
export function SimpleMoneyManagement({ data }: { data: MoneyManagementPageData }) {
  ...
  return <div className="mx-auto w-full max-w-[1440px] space-y-6 px-4 pb-4 pt-6 md:px-6">

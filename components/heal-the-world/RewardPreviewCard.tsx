...
const fallbackReward: BloodDonationReward = {
...
export function RewardPreviewCard({ reward, isMissionCompleted = false }: Props) {
  const displayReward = reward ?? fallbackReward;
        ...
        <div className="grid md:grid-cols-[1.1fr,1.4fr]">
          ...
          <div className="space-y-3 p-4 sm:p-5 md:p-6">
            <div className="flex flex-wrap items-start justify-between gap-2.5">
              <div>
                <p className="text-[11px] uppercase tracking-[0.24em] text-cyan-100/75">Reward Preview</p>
            ...
            <p className="text-sm italic leading-relaxed text-cyan-100/90">“{displayReward.emotionalCopy}”</p>

  ...
  return (
    <section className="rounded-3xl border border-white/10 bg-gradient-to-br from-[#0F1B2E] to-[#07111F] p-5 shadow-[0_12px_36px_rgba(6,14,30,0.55)]">
      ...
      <div className="mt-4 flex flex-wrap gap-2.5">
        <a href="#quick-log" className="theme-button-primary inline-flex items-center justify-center px-5 py-2.5 text-base !text-[#FFFFFF] hover:!text-[#FFFFFF] active:!text-[#FFFFFF]">บันทึกผลวิ่ง</a>
